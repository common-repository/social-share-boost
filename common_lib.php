		...
		<div class="postbox">
			...
			<div class="inside">
				...
				<div class="row has_ifr">
					<p><a target="_blank" href="http://sumo.com/app/share/?src=ssb">Share</a> - Get more traffic to your site with these super easy to setup share buttons!</p>
					<p><a target="_blank" href="http://sumo.com/app/list-builder/?src=ssb">List Builder</a> - Double your daily email list growth</p>
					<p><a target="_blank" href="http://sumo.com/app/scroll-box/?src=ssb">Scroll Box</a> - Ask for an email address at the right time</p>
...
if(!function_exists('syntatical_get_fields_html')){
	function syntatical_get_fields_html($field_ary,$i,$optn_val)
	{
		...
		$html.= '<div class="wp-tab-panela" id="tab'.$i.'" '.$class.' >
			<div style="margin: 5px 0 15px;" class="coffe_box"><p><a style="text-decoration:none;" href="http://sumo.com/?src=ssb" target="_blank">Get more free tools to increase your sharing at Sumo.com</p></div>
