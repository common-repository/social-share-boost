...
class ssb_widget extends WP_Widget{
	...
	{
		parent::__construct(false, $name = 'Social Share Boost');
	}
...
class ssb_fb_like_widget extends WP_Widget{
	function __construct()
	{
		parent::__construct(false, $name = 'Social Share Boost :: Like Box');
	}
	function widget($args, $instance)
	{
		extract( $args );
...
class ssb_icons_widget extends WP_Widget{
	function __construct()
	{
		parent::__construct(false, $name = 'Social Share Boost :: Social Profile Icons');
	}
	function widget($args, $instance)
	{
		extract( $args );
